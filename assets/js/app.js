"use strict";
(self["webpackChunkattibling"] = self["webpackChunkattibling"] || []).push([["/js/app"],{
...
/* harmony import */ var headroom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! headroom.js */ "./node_modules/.pnpm/headroom.js@0.12.0/node_modules/headroom.js/dist/headroom.js");
...
/* harmony import */ var tippy_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tippy.js */ "./node_modules/.pnpm/tippy.js@6.2.4/node_modules/tippy.js/dist/tippy.esm.js");
/* harmony import */ var tippy_js_dist_tippy_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tippy.js/dist/tippy.css */ "./node_modules/.pnpm/tippy.js@6.2.4/node_modules/tippy.js/dist/tippy.css");
/* harmony import */ var shave__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! shave */ "./node_modules/.pnpm/shave@2.5.10/node_modules/shave/dist/shave.es.js");
/* harmony import */ var _tryghost_content_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @tryghost/content-api */ "./node_modules/.pnpm/@tryghost+content-api@1.11.1/node_modules/@tryghost/content-api/es/content-api.js");
/* harmony import */ var fuse_js_dist_fuse_basic_esm_min_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! fuse.js/dist/fuse.basic.esm.min.js */ "./node_modules/.pnpm/fuse.js@6.4.6/node_modules/fuse.js/dist/fuse.basic.esm.min.js");
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! swiper */ "./node_modules/.pnpm/swiper@8.0.3/node_modules/swiper/swiper.esm.js");
/* harmony import */ var swiper_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! swiper/css */ "./node_modules/.pnpm/swiper@8.0.3/node_modules/swiper/swiper.min.css");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  if ((0,_helpers__WEBPACK_IMPORTED_MODULE_8__.isRTL)()) {
  ...
  var $themeSwitcher = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-switch-theme");
  ...
  var $darkColorsScheme = window.matchMedia("(prefers-color-scheme: dark)");
  var fuse = null;
  ...
  var getAllPosts = function getAllPosts(host, key) {
    ...
    api.posts.browse({
      ...
      fuse = new fuse_js_dist_fuse_basic_esm_min_js__WEBPACK_IMPORTED_MODULE_5__["default"](allPosts, fuseOptions);
    })["catch"](function (err) {
      console.log(err);
    });
  };
  var toggleDesktopTopbarOverflow = function toggleDesktopTopbarOverflow(disableOverflow) {
    if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_8__.isMobile)()) {
      if (disableOverflow) {
    ...
    if ($inputSearch.val().length > 0 && fuse) {
      ...
      if (bestResults.length > 0) {
        for (var i = 0, len = bestResults.length; i < len; i++) {
          htmlString += "\n          <article class=\"m-result\">            <a href=\"".concat(bestResults[i].item.url, "\" class=\"m-result__link\">              <h3 class=\"m-result__title\">").concat(bestResults[i].item.title, "</h3>              <span class=\"m-result__date\">").concat((0,_helpers__WEBPACK_IMPORTED_MODULE_8__.formatDate)(bestResults[i].item.published_at), "</span>            </a>          </article>");
        }
  ...
  var $resetThemeIcons = function $resetThemeIcons() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".light-theme-icon").css("display", "none");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".dark-theme-icon").css("display", "none");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".auto-theme-icon").css("display", "none");
  };
  var $setLightTheme = function $setLightTheme() {
    $resetThemeIcons();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").attr("data-theme", "light");
    localStorage.setItem("theme", "light");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".light-theme-icon").css("display", "block");
  };
  var $setDarkTheme = function $setDarkTheme() {
    $resetThemeIcons();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").attr("data-theme", "dark");
    localStorage.setItem("theme", "dark");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".dark-theme-icon").css("display", "block");
  };
  var $setAutoTheme = function $setAutoTheme() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".auto-theme-icon").css("display", "block");
  };
  $darkColorsScheme.addEventListener("change", function () {
    $setAutoTheme();
  });
  ...
  if ($header.length > 0) {
    var headroom = new (headroom_js__WEBPACK_IMPORTED_MODULE_1___default())($header[0], {
      ...
      onUnpin: function onUnpin() {
        if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_8__.isMobile)() && secondaryMenuTippy) {
  ...
  if ($recentSlider.length > 0) {
    var recentSwiper = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"](".js-recent-slider", {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_6__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_6__.A11y],
      freeMode: true,
      slidesPerView: "auto",
      a11y: true,
      on: {
